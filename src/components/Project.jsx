...
const techIcons = {
  ...
  shadcn: <SiShadcnui size={18} />
};

const Project = ({ project }) => {
  return (
    <div className="rounded-3xl border border-gray-700 bg-[radial-gradient(190px_circle_at_50%_200px,#245770,transparent)] p-5 shadow-lg transition-transform hover:-translate-y-1 hover:shadow-2xl h-[675px] flex flex-col justify-between">
      <div>
        <img
          src={project.image}
          alt={project.title}
